...
this.textChunk = [
  ...
  "After an eternity of moving through the ether, Mani found a land of crystals.",
  "","",
...
crystals.addToActivateArray( function(){
  ...
  this.text.physics.createDebugScene();
  this.text.physics.addDebugScene( this.scene );

  this.text.physics.debugScene.scale.multiplyScalar( 20 );
  ...
  var callback = function(){
    ...
    this.tweenCamera( this.cameraPos2 , (timeTilEnd-.01) * 1000 , function(){
      ...
      console.log( this.transitionMesh2 );
  ...
  console.log( this.scene );
  console.log( this.transitionMesh1 );
